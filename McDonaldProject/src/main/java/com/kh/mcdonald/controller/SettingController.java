...
//		System.out.println("doGet 잘옴?");
		 ...
		 * JSP페이지 내에서만 사용가능
		 * 
		 * => 위 객체들에 값을 담을때는 .setAttribute("Key","Value")
		 * 						   .getAttribute("Key")
		 * 						   .removeAttribute("Key")
		 * 
		 */	
